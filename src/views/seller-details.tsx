  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const { totalCount = 0, topTypes = [] } = await getPropertiesByUserId(
          user.user_id,
          {
          ...
          {isAuthenticated && (
            <Button
              ...
              className={`mt-4 w-full ${
                favorites ? "bg-rose-500 hover:bg-rose-600" : ""
              }`}
              onClick={() => handleToggleFavorite(seller.user_id)}
            >
              <Heart
                className={`h-5 w-5 mr-2 ${favorites ? "fill-white" : ""}`}
              />
              {favorites
                ? `${tSeller("unfavorite")}`
                : `${tSeller("favorite")}`}
        ...
        <TabsContent value="contacto" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Completa el formulario y {seller.nombre} se pondrá en contacto
              ...
              {!enviado ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Gracias por contactar con {seller.nombre}. Te responderá lo
                    antes posible.
                  </p>
